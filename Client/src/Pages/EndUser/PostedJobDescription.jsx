...
function PostedJobDescription() {
  ...
  const fetchJobDescription = () => {
    // axios POST request
    const options = {
      url: import.meta.env.VITE_API_URL + "/job/get-jobs/details",
      method: "POST",
      headers: {
  ...
  return (
    <div className=" h-screen">
      <div className="w-full h-56 bg-gradient-to-b from-blue-900 to-blue-600 bg-gradient-to-r shadow-xl">
        {/* <img
          style={{ opacity: 0.2 }}
      ...
      <div
        className="w-4/5 m-auto bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-blue-300 via-blue-100 to-blue-200 bg-opacity-30 p-6 mt-12 h-auto rounded-lg shadow-lg
