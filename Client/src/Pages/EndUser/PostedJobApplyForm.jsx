...
function PostedJobApplyForm() {
  ...
  const universitiesInMorocco = [
    ...
    "Hassan II University of Agriculture and Veterinary Medicine",
  ...
  const submit = async (e) => {
    ...
    const options = {
      url: import.meta.env.VITE_API_URL + "/job/apply-to-job",
      method: "POST",
      headers: {
  ...
  return (
    <div>
      <div className="bg-gradient-to-b from-blue-900 to-blue-600 bg-gradient-to-r h-40 flex items-center justify-center shadow-xl">
      ...
      {showModal == true ? (
        <div className="z-10 bg-white justify-center w-1/3 left-1/3 4 mt-12 p-6 modalShadow m-auto absolute">
          ...
          <button
            ...
            className="shadow bg-blue-500 p-3 rounded-lg block m-auto heading4 text-white mt-4 hover:bg-blue-600"
          >
            Go Back
          </button>
        </div>
      ...
      <div
        ...
        className="w-4/5 m-auto bg-blue-100 rounded-lg shadows flex flex-wrap gap-6 p-8 mt-12 mb-12"
      >
        ...
        <div className="ml-2 ">
          ...
          <DatePicker
            showIcon
            className="cursor-pointer bg-white w-44 p-2 rounded-md border border-solid border-blue-300"
            selected={startDate}
        ...
        <div className="ml-8">
          ...
          <select
            ...
            className="select select-bordered w-full  max-w-xs text-blue-500"
          >
            <option disabled selected className="text-blue-700">
              Select Gender
            </option>
        ...
        <div className=" w-2/6">
          ...
          <input
            ...
            name="address"
            autoComplete="on"
            placeholder="Rue 27 Mers sultan"
        ...
        <div className="mt-2 flex justify-center m-auto p-4 items-center bg-transparent shadow-md cursor-pointer h-1/2 rounded-md">
          <div
            className="border bg-transparent border-blue-400 border-dashed rounded-md p-4 flex flex-col items-center justify-center
            hover:bg-blue-100
          "
          >
        ...
        <div className="w-1/4">
          ...
          >
            ...
            {universitiesInMorocco.map((univ) => (
        ...
        <div className=" w-full">
          ...
          <FiPlusCircle
            ...
            text-4xl cursor-pointer  text-blue-600 m-auto block text-center"
          >
            Add More
          </FiPlusCircle>
        ...
        <div className=" w-1/3 ">
          ...
          <input
            ...
            autoComplete="on"
            placeholder="linkedin.com/ismail-hamdach"
            onChange={(e) => {
              setContactInformation((old) => ({
                ...old,
        ...
        <div className=" w-1/3 ml-10 ">
          ...
          <input
            ...
            name="linkedin profile"
            autoComplete="on"
            placeholder="github.com/ismail-hamdach"
            onChange={(e) => {
              setContactInformation((old) => ({
                ...old,
      ...
      <footer className="bg-blue-700 h-12 flex justify-center items-center">
        <h3 className="text-white line1">Powerd By KHEDMTY </h3>
      </footer>
    </div>
  );
}
